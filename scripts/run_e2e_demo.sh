...
echo "========================================"
echo ""
echo "MONITORING (open these in separate terminals):"
echo "  MongoDB:  bash scripts/watch_mongodb.sh"
echo "  pgvector: bash scripts/watch_pgvector.sh"
echo "  MLflow:   open http://localhost:5001"
echo "  FastAPI:  open http://localhost:8001/docs"
echo ""
